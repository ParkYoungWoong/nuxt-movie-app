export default {
  ...
  head: {
    ...
    meta: [
      ...
      { hid: 'og:title', property: 'og:type', content: 'Nuxt Movie App / Search' },
      { hid: 'og:description', property: 'og:type', content: 'Hello Nuxt!' },
      { hid: 'og:image', property: 'og:type', content: 'https://heropy.blog/css/images/logo.png' },
